...
export const CreateArticle = () => {
    ...
    const createArticle = async (e) => {
        ...
        if (!content.current.value || !title.current.value || !decription.current.value) {
        ...
        const request = {
            ...
            description: decription.current.value,
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (response.status === 401) {
                    toast.success('could not create article')
                }
            }
        } catch (error) {
                ...
                <form onSubmit={createArticle}>
                    <div className="flex flex-col flex-wrap">
                        <div className="mb-6">
                            ...
                            <input type="text" id="default-input" className="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" ref={title} />
                        </div>
                        <div className="mb-6">
                            <label htmlFor="default-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">description</label>
                            <input type="text" id="default-input" className="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" ref={decription} />
                        </div>
                        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <textarea id="editor" rows="8" className="outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." ref={content} ></textarea>
                            </div>
                        </div>
                        <div className="">
